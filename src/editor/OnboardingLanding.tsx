...
const OnboardingLanding = ({ onOpenNewProject, onOpenProjectFile }: Props) => {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6 rounded-2xl border border-surface-300/60 bg-surface-200/80 p-8 text-center shadow-panel">
      ...
      <p className="text-xs text-slate-500">Your edits autosave locally while you work.</p>
    </div>
  )
}
