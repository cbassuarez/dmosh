      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-16 px-4 pb-16 pt-10">
        <section className="grid gap-10 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] md:items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-black/50 px-3 py-1 text-xs text-slate-400">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm">
              ...
              <a
                href="/dmosh/docs/"
                className="rounded-full border border-slate-800 px-4 py-2 text-slate-200 transition hover:border-teal-400 hover:text-teal-300"
              >
                Read docs
              </a>
              <Link
          ...
          <motion.div
            className="rounded-2xl border border-slate-800 bg-black/60 p-4 shadow-xl shadow-black/60"
          ...
          >
            <div className="mb-3 flex items-center justify-between text-[0.65rem] text-slate-400">
              ...
              <span className="rounded-full border border-slate-800 px-2 py-0.5 text-slate-500">I · P · B</span>
            </div>
            <div className="aspect-video rounded-lg border border-slate-800 bg-gradient-to-br from-slate-900 via-black to-slate-900">
            ...
            <div className="mt-3 h-10 rounded-md border border-slate-800 bg-black/70">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {featureCards.map((card) => (
              <div
                key={card.title}
                className="rounded-xl border border-slate-800 bg-black/50 p-4 text-sm text-slate-200"
              >
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-xl border border-slate-800 bg-black/50 p-4 text-xs text-slate-300">
            <p className="mb-2">
