...
- `npm run test:e2e` — run Playwright smoke test against the dev server

## Deploy
Configured for GitHub Pages (`vite.config.ts` uses the repo base). A CI workflow builds and deploys from `work`.
